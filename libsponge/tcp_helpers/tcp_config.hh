...
class TCPConfig {
  public:
    ...
    //!< Whether to enable TCP Reno congestion control (slow start, congestion
    //!< avoidance, fast retransmit, fast recovery). When false, the sender
    //!< only applies flow control based on the receiver's advertised window,
    //!< which is the original CS144 behavior.
